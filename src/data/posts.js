...
export const users = [
  {
    ...
    lastName: "Hallen",
    imageUrl:
      "https://www.pilotonline.com/resizer/V3Hgvxt9fH6g30zmIJMK8x1JBSE=/415x580/top/cloudfront-us-east-1.images.arcpublishing.com/tronc/ZSLHN26MHRGX5PPL6I4O6LINQI.jpg",
    color: "#1B1464",
    initial: "F",
...
export const comments = [
  {
    ...
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam eget lorem nisi. Vestibulum venenatis finibus mauris, in suscipit velit. Integer ipsum lectus, eleifend nec magna in, consequat luctus nibh. Morbi et tellus mollis, placerat quam id, vehicula enim. Proin quam felis, vehicula id lacus id, lacinia varius leo. Ut congue velit turpis, vitae pellentesque nisl tincidunt nec. Cras nec tincidunt lectus. Aliquam erat lorem",
    createdAt: 2863909288726,
    likes: 56,
  },
];
